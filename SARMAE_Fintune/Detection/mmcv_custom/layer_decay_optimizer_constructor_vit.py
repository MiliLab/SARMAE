...
try:
    ...
    OLD_REGISTRY_AVAILABLE = True
except ImportError:
    OLD_REGISTRY_AVAILABLE = False
...
if OLD_REGISTRY_AVAILABLE:
    @OPTIMIZER_BUILDERS.register_module()
    class LayerDecayOptimizerConstructor_ViT_Old(DefaultOptimizerConstructor):
        def add_params(self, params, module, prefix='', is_dcn_module=None):
            """Add all parameters of module to the params list."""
            parameter_groups = {}
            print(self.paramwise_cfg)

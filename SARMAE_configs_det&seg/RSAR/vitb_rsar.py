...
data = dict(
    ...
    train=dict(
        type='RSARDataset',
        ann_file='./det/RSAR/train/annfiles/',
        img_prefix='./det/RSAR/train/images/',
        pipeline=[
    ...
    val=dict(
        type='RSARDataset',
        ann_file='./det/RSAR/test/annfiles/',
        img_prefix='./det/RSAR/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(

...
data = dict(
    ...
    train=dict(
        type='SARDet_hbb',
        ann_file=
        './det/SARDet_100K_new/Annotations/train.json',
        img_prefix=
        './det/SARDet_100K_new/JPEGImages/train/',
        pipeline=[
    ...
    val=dict(
        type='SARDet_hbb',
        ann_file=
        './det/SARDet_100K_new/Annotations/val.json',
        img_prefix=
        './det/SARDet_100K_new/JPEGImages/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='SARDet_hbb',
        ann_file=
        './det/SARDet_100K_new/Annotations/test.json',
        img_prefix=
        './det/SARDet_100K_new/JPEGImages/test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
work_dir = './work_dirs/vitb_sardet100k'
auto_resume = True
gpu_ids = range(0, 8)
device = 'cuda'
